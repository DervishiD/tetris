...
public val statsScreen : StatsScreen by lazy{ StatsScreen() }
...
public val nSelector : Selector by lazy{ Selector(N_SELECTOR_X, N_SELECTOR_Y, possibleN()) }
public val statsSelector : Selector by lazy{ Selector(STATS_SELECTOR_X, STATS_SELECTOR_Y, possibleN()) }
...
public val statsLabel : Text by lazy{Text("Stats", QUESTION_FONT, STATS_LABEL_X, STATS_LABEL_Y, STATS_LABEL_WIDTH, STATS_LABEL_HEIGHT)}
